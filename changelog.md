...
- <cg>Added</c> support for any key presses.
- <cg>Reworked</c> ALL visuals.
- <cg>Reworked</c> a lot of code.
- <cy>Improved</c> position settings.
- <cy>Improved</c> counter settings.
- <cr>Fixed</c> popups appearing behind others (Thanks Geode v5).
- <cr>Fixed</c> paws getting stuck on scroll layers.
- <cr>Removed</c> the unlock system. This means all items are now unlocked by default. This decision was made to remove a lot of bloat from the project, ensuring more content can get added more easily in the future.
